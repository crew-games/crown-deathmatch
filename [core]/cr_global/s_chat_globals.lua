...
oocState = getElementData(root,"globalooc:state") or 0
...
function setOOCState(state)
	oocState = state
	setElementData(root,"globalooc:state", state, false)
end
...
addEventHandler("sendLocalChatAction", root, sendLocalMeAction)
