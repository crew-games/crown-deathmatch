...
function getInteriorsOwnByFaction(theFaction) --Farid
	local ints = {}
...
function canPlayerFactionBuyInterior(thePlayer, cost) -- Farid
	local factionId = getElementData(thePlayer, "faction")
	local theFaction = exports.cr_pool:getElement("team", factionId)
...
function canFactionBuyInterior(theFaction, cost) -- Farid
