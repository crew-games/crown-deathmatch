						...
						for key, player in ipairs(getElementsByType("player")) do
							...
							if getElementData(player, "loggedin") == 1 and playerVIP <= 4 then
								...
								if isPlayerVIP(charID) then
									...
									outputChatBox("[!]#FFFFFF Crown Deathmatch tarafından VIP [" .. playerVIP .. "] sürenize " .. addDay .. " gün daha eklendi!", player, 0, 255, 0, true)
									triggerClientEvent(player, "playSuccessfulSound", player)
								else
									removeVIP(charID)
									addVIP(player, vipID, vipDay)
									outputChatBox("[!]#FFFFFF Crown Deathmatch tarafından " .. vipDay .. " günlük VIP [" .. vipID .. "] kazandınız!", player, 0, 255, 0, true)
									triggerClientEvent(player, "playSuccessfulSound", player)
								end
							end
						end
