...
addEventHandler("onVehicleRemoteAlarm", root, onVehicleDamage)
...
function district()
	...
	local zonename = exports.cr_global:getElementZoneName(source)
...
addEventHandler("alarmDistrict", root, district)