...
addEventHandler("onPlayerQuit", root, removeBackboneOnExit)
...
function updateBackBone()
	local thePlayerTable = getElementsByType ("player", root, false)
...
addEventHandler("onClientRender", root, updateBackBone)
...
addEventHandler("onClientResourceStart", resourceRoot,
	function (startedRes)
		triggerServerEvent("realism:backbone.request", localPlayer)
	end
);

addEvent("realism:backbone.addBackboneItem", true)
addEventHandler("realism:backbone.addBackboneItem", root, addBackboneItem)

addEvent("realism:backbone.removeBackboneItem", true)
addEventHandler("realism:backbone.removeBackboneItem", root, removeBackboneItem)