...
function onCopCarEnter(thePlayer, seat)
	if (seat < 2) and (thePlayer==localPlayer) then
...
addEventHandler("onClientVehicleEnter", root, onCopCarEnter)
...
addEventHandler("onClientPlayerWeaponFire", root, realisticWeaponSounds)
