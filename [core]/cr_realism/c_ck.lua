...
addEventHandler("showCKList", localPlayer,
	function(names, data)
		if wCK then
			destroyElement(wCK)
			wCK = nil
...
function clickCKBody(button, state, absX, absY, wx, wy, wz, element)
	...
	if (button=="right") and (state=="down") then
		for k, v in pairs(getElementsByType("ped", resourceRoot)) do
...
addEventHandler("onClientClick", root, clickCKBody)
...
addEventHandler("ck:show", root, showCKInfo)
