...
function doGearCheck()
	...
	if not exports.cr_integration:isPlayerTrialAdmin(localPlayer) and not exports.cr_global:cisPlayerBronzeDonator(localPlayer)  then
		return
	end
...
addEventHandler("onClientRender", root, doGearCheck)
...
addEventHandler("OnClientVehicleExit", root, getGearStateOnEnter)