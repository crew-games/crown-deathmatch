...
addEventHandler("onClientResourceStart",root,setUp)
...
addEventHandler("realism:distance", root, receiveDistanceSync)
...
addEventHandler("onClientPlayerVehicleEnter", localPlayer, bikeSpeed)