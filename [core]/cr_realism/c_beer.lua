...
addEventHandler("realism:drinkingsync", root, syncbeerette, righthand)

addEventHandler("onClientResourceStart", resourceRoot,
	function (startedRes)
		triggerServerEvent("realism:drinking.request", localPlayer)
	end
);
...
addEventHandler("onClientPreRender", root, updateBeer)
