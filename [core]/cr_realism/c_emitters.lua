...
function streamInEmitter()
	if (getElementType(source)=="object") and getElementParent(getElementParent(source)) == resourceRoot then
...
addEventHandler("onClientElementStreamIn", root, streamInEmitter)
...
addEventHandler("onClientElementStreamOut", root, streamOutEmitter)