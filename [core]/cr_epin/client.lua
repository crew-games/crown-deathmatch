...
function openWindow()
    ...
    window = guiCreateWindow((screenW - 545) / 2, (screenH - 311) / 2, 545, 205, "Crown Deathmatch - E-pin Aktifleştirme Arayüzü", false)
