...
addEventHandler("durtmeSesi", localPlayer, babaPatlat)
...
addEventHandler("ahlayanSesi", localPlayer, babaPatlat2)
...
addEventHandler("doEarthquake", localPlayer, doEarthquake)
...
function buildCargoGUI()
	...
	addEventHandler("onClientGUIClick", cargogui["pushButton_2"], function ()
		...
		triggerServerEvent("createCargoGeneric", resourceRoot, localPlayer, "cmg", price, name)
		end, false)
...
addEventHandler("nahVer", root,
	function()
		local screenWidth, screenHeight = guiGetScreenSize()
		local nah = guiCreateStaticImage((screenWidth / 2) - (750/2), (screenHeight / 2) - (600/2), 750, 600, ":cr_admin/weapIcons/nah.png", false)
