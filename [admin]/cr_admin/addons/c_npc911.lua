...
function build_Dialog()
	...
	addEventHandler("onClientGUIClick", gui["pushButton"], function()
			triggerServerEvent("npc911", resourceRoot, localPlayer, guiGetText(gui["lineEdit"]), guiGetText(gui["lineEdit_2"]))
...
addEventHandler("buildGUI_npc911", resourceRoot, build_Dialog)
