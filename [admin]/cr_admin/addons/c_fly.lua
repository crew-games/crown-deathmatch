...
addEventHandler("onClientFlyToggle",localPlayer,function()
	flyingState = not flyingState
	
	if flyingState then
		addEventHandler("onClientRender",root,flyingRender)
		...
		removeEventHandler("onClientRender",root,flyingRender)
