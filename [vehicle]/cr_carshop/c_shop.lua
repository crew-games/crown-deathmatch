...
addEventHandler("carshop:showInfo", root, carshop_showInfo)
...
function carshop_buyCar(carPrice, cashEnabled, bankEnabled)
	...
	gui["_root"] = guiCreateStaticImage(left, top, windowWidth, windowHeight, ":cr_ui/public/images/window_body.png", false)
...
addEventHandler("carshop:buyCar", root, carshop_buyCar)]]

function carshop_buyCar_click()
	if exports.cr_global:hasSpaceForItem(localPlayer, 3, 1) then
...
addEventHandler ("onSapphireXMBShow", root, carshop_buyCar_close)
addEventHandler("onClientChangeChar", root, carshop_buyCar_close)
...
--PREVENT ABUSER TO CHANGE CHAR
addEventHandler ("onSapphireXMBShow", root, carshop_buyCar_close2)
addEventHandler("onClientChangeChar", root, carshop_buyCar_close2)
