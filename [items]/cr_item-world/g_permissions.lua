...
itemtexture = exports['cr_item-texture']
global = exports.cr_global
integration = exports.cr_integration

function canEditItemProperties(thePlayer, object)
	if not object then return false end
	local interiorID = getElementDimension(object)
	if exports.cr_global:hasItem(localPlayer, 4, interiorID) or exports.cr_global:hasItem(localPlayer, 5, interiorID) or (exports.cr_integration:isPlayerTrialAdmin(thePlayer) and exports.cr_global:isAdminOnDuty(thePlayer)) or exports.cr_integration:isPlayerScripter(thePlayer) then
		return true
	end
	return false
end
...
function can(player, action, element)
	...
	elseif usePerm == 3 then --admin only
		if (integration:isPlayerAdmin1(player) and global:isAdminOnDuty(player)) then
			return true
		end
