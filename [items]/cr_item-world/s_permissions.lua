...
function getItemPropertiesData(object)
	...
	if creatorName then
		triggerClientEvent(client, "item-world:fillItemPropertiesGUI", resourceRoot, object, creatorName)
	end
end
addEvent("item-world:getItemPropertiesData", true)
addEventHandler("item-world:getItemPropertiesData", resourceRoot, getItemPropertiesData)
...
addEventHandler("item-world:saveItemProperties", resourceRoot, saveItemProperties)