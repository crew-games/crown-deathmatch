...
function popupJesPedMenu()
	...
	vmOptionMenu = guiCreateStaticImage(x, y, width, height, ":cr_ui/public/images/window_body.png", false)
...
addEventHandler("cityhall:jesped", root, popupJesPedMenu)
...
function bJobF()
	closevmPedMenu()
	triggerEvent("onEmployment", localPlayer)
end

function newIDCard()
	closevmPedMenu()
	triggerServerEvent("cityhall:makeIdCard", localPlayer)
end
