...
function addWearablePlayer(player, temp_table)
    if tonumber(player:getData("loggedin")) == 1 then
        ...
        exports.cr_bones:attachElementToBone(createdObject, player, temp_table.bone, temp_table.x, temp_table.y, temp_table.z, temp_table.rx, temp_table.ry, temp_table.rz);
