...
local maxFileSize = 1000000 --50kb
local maxFileSizeTxt = "1000kb"
...
addEventHandler("vehtex:addTexture", root, addVehicleTexture)
...
addEventHandler("vehtex:removeTexture", root, removeVehicleTexture)
