...
--Based upon iG texture-system (based on Exciter's uG/RPP texture-system) and Crown Deathmatch/Cat's fixes to texture-system based on mabako-clothingstore. 
