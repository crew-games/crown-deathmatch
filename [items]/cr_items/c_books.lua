...
function showBook(title, author, book, readOnly, slot, id)
    ...
    addEventHandler("onClientGUIClick", BookGUI.button[2], function()
    	...
    	triggerServerEvent("books:setData", localPlayer, id, guiGetText(BookGUI.edit[1]), guiGetText(BookGUI.edit[2]), guiGetText(BookGUI.memo[1]), true)
    ...
    addEventHandler("onClientGUIClick", BookGUI.button[3], function()
		...
		triggerServerEvent("books:setData", localPlayer, id, guiGetText(BookGUI.edit[1]), guiGetText(BookGUI.edit[2]), guiGetText(BookGUI.memo[1]), false)
		newValue(guiGetText(BookGUI.edit[1]), guiGetText(BookGUI.edit[2]), id, slot)
    	destroyElement(BookGUI.window[1]) 
    	showCursor(false) 
    	guiSetInputEnabled(false)
