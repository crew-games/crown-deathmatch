...
addEventHandler("item-system:deletemoney", root, DeleteMoneyItem)
...
--[[ALREADY IN cr_admin/Player/s_licenses.lua
...
addEventHandler("item-system:saveTextureURL", root, saveTextureURL)
...
addEventHandler("item-system:saveTextureReplacement", root, saveTextureReplacement)