function getNearbyObjects(commandName)
	if exports.cr_integration:isPlayerAdmin1(localPlayer) then
		outputChatBox("Nearby worldobjects:", 255, 126, 0)
		local count = 0
		
		for index, nearbyObject in ipairs(exports.cr_global:getNearbyElements(localPlayer, "object")) do
...
function fixes()
	setTimer(function()
		setOcclusionsEnabled(false) -- to fix the object streaming issue (extreme low draw distance) / Farid
	end, 10000, 1)
end
