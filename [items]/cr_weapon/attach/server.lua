...
function createModel(weapon, bone, x, y, z, rx, ry, rz)
	...
	if objectID then
		...
		exports.cr_bones:attachElementToBone(object, player, bone, x, y, z, rx, ry, rz)
...
addEventHandler("onPlayerVehicleEnter", root, alphaWepsVehicle)
...
addEventHandler("onPlayerVehicleExit", root, unalphaWepsVehicle)