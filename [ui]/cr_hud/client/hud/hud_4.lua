...
local ITEMS = {
	["health"] = {
        icon = "",
        color = tocolor(234, 83, 83),
        iconColor = tocolor(249, 168, 168)
    },
    ["armor"] = {
        icon = "",
        color = tocolor(217, 217, 217),
        iconColor = tocolor(140, 140, 140)
    },
    ["level"] = {
        icon = "",
        color = tocolor(216, 181, 26),
        iconColor = tocolor(239, 223, 85)
    },
}
