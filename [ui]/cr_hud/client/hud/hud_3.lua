...
setTimer(function()
    if getElementData(localPlayer, "loggedin") == 1 then
		if getElementData(localPlayer, "hud_settings").hud == 3 then
		    ...
		    dxDrawImage(screenX + 10, screenY + 5, 80, 80, "public/images/weapons/" .. weapon .. ".png")
	        ...
	        dxDrawText("$" .. exports.cr_global:formatMoney(getElementData(localPlayer, "bankmoney")), screenX + 132, screenY + 52, nil, nil, tocolor(255, 255, 255, 255), 1, fonts.font1)
		end
	end
end, 0, 0)