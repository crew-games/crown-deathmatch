...
setTimer(function()
	if getElementData(localPlayer, "loggedin") == 1 then
		if getElementData(localPlayer, "hud_settings").hud == 6 then
			...
			dxDrawImage(screenX, screenY + 6, 90, 90, "public/images/weapons/" .. weapon .. ".png")
			...
			dxDrawText("", screenX, screenY + 29, screenX + sizeX - 22 - dxGetTextWidth(exports.cr_global:formatMoney(exports.cr_global:getMoney(localPlayer)), 1, fonts.main), 0, tocolor(85, 152, 78, 255), 1, fonts.icon, "right")
			...
			dxDrawText("", screenX, screenY + sizeY - 51, screenX + sizeX - 22 - dxGetTextWidth(exports.cr_global:formatMoney(getElementData(localPlayer, "bankmoney")), 1, fonts.main), 0, tocolor(217, 217, 217, 255), 1, fonts.icon, "right")
