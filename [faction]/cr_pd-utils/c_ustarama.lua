function ustAramaOnayGUI(arayan, aranan)
    ...
    ustAramaSorWindow = guiCreateWindow((screenW - 455) / 2, (screenH - 141) / 2, 455, 141, "Crown Deathmatch - Üst Arama Sistemi", false)
	...
	addEventHandler("onClientGUIClick", aramaKabulEtSorBtn, function() destroyElement(ustAramaSorWindow) triggerServerEvent("pd:aramaKabul", arayan, arayan, aranan) 
setElementData(arayan, "ustArama", false)
end)
	...
	addEventHandler("onClientGUIClick", aramaReddetBtn, function() destroyElement(ustAramaSorWindow) triggerServerEvent("pd:aramaRed", arayan, arayan, aranan) 
setElementData(arayan, "ustArama", false)
end)
end
